<?php 
	...
	if (isset($_POST['dangnhap'])) {
		...
		if ($tendangnhap && $matkhau) {
 		   	$sql= "SELECT idtk,tendangnhap,matkhau,capdotruycap,mstt  from taikhoan where tendangnhap ='".$tendangnhap."' ";
...
<body style="background-color: #99ffcc;
	...
	<div class="layout-khung">
		...
		<div class="layout-center">
			<div style="width: 100%; float: left; height: 50%;">
			...
			<div class="layout-3">
				<form action="dangnhap.php" method="POST" accept-charset="utf-8">
					...
					<div class="layout-us-pw">
						<input class="kich-thuoc-chu" type="password" name="matkhau" value="" required placeholder="Nhập mật khẩu">
					</div>
					<div class="layout-us-pw">
						<table style="border:40px;">
							...
							<tr>
								<a href="../index.php" title=""><input class="kich-thuoc-chu-ok" type="button" name="thoat" value="Thoát"></a>
							</tr>											
						</table>
						<br> 
						<p style="margin: auto; text-align: center; padding-bottom: 30px; color: #990000;">Chưa có tài khoản   &nbsp <a href="dangky.php" title="">Đăng ký </a></p>
